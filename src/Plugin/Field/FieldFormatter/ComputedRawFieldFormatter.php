...
/**
 * Plugin implementation of the 'computed_raw_field_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "computed_raw_field_formatter",
 ...
 * )
 */
class ComputedRawFieldFormatter extends FormatterBase {
  /**
   * {@inheritdoc}
   */
